...
# shuffling the raw bits to remove some correlation in position
...
def plot_ecdf(data, name):
    ...
    plt.show()  # Return figure instead of showing it
...
if __name__ == '__main__':
  ...
  for i in range(len(img_files)-1):
    i = 1 # im just after the A1A1A1OF image not TestTest
    ...
    #ECDF_plot = plot_ecdf(data_Raw, name)
    #print(ECDF_plot)
    #hist_plot = plotting_hist(data_Raw, name)
    #print(hist_plot)
